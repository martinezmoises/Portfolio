      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-lg border border-white/10 shadow-2xl transition-all duration-300 hover:shadow-blue-500/20">
        ...
        <div className="relative p-5 z-10">
          ...
          <div className="mt-4 space-y-3">
            <h3 className="text-xl font-semibold bg-gradient-to-r from-blue-200 via-cyan-200 to-sky-200 bg-clip-text text-transparent">
              {Title}
            </h3>
            ...
            <div className="pt-4 flex items-center justify-between">
              {ProjectLink ? (
                <a
                  ...
                  className="inline-flex items-center space-x-2 text-blue-400 hover:text-cyan-300 transition-colors duration-200"
                >
