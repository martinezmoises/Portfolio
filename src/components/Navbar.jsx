                ...
                <div className="flex items-center justify-between h-16">
                                    ...
                                    <span
                                        className={`relative z-10 transition-colors duration-300 ${
                                            activeSection === item.href.substring(1)
                                                ...
                                                : "text-[#cfe8ff] group-hover:text-white"
                                        }`}
                                    >
                                        {item.label}
                                    </span>
                    ...
                    <div className="md:hidden">
                        <button
                            ...
                            className={`relative p-2 text-[#cfe8ff] hover:text-white transition-transform duration-300 ease-in-out transform ${
