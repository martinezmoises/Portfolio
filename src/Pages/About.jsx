  ...
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
    ...
    >
      ...
      <div className="absolute -inset-6 opacity-[25%] z-0 hidden sm:block">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-800 via-blue-600 to-cyan-600 rounded-full blur-2xl animate-spin-slower" />
        <div className="absolute inset-0 bg-gradient-to-l from-sky-500 via-cyan-500 to-teal-500 rounded-full blur-2xl animate-pulse-slow opacity-50" />
...
const statsData = useMemo(() => [
  {
    ...
    description: "Projects I've built for fun and paid projects",
  ...
  },
  {
    ...
    value: "",
    label: "Education",
    description: "Bachelor of Science in Information Technology (Cum Laude)",
    animation: "fade-up",
  },
], []);
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
            Versatile and results-driven Software Developer with hands-on experience in full-stack web application development. Skilled in building scalable and efficient solutions using modern frameworks, cloud services, and API integrations. Passionate about crafting clean, user-centered designs and delivering high-quality digital products that solve real-world challenges. Constantly learning and improving to bring innovation and reliability to every project.
            </p>

               {/* Quote Section */}
      <div 
        className="relative bg-gradient-to-br from-[#3b82f6]/5 via-transparent to-[#06b6d4]/5 border border-[#3b82f6]/30 rounded-2xl p-4 my-6 backdrop-blur-md shadow-2xl overflow-hidden"
        data-aos="fade-up"
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Stay curious, stay consistent, and keep building"
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1NFxUY9qXAV2e2BEPaL4NPRTSVnpc5NU2/view?usp=drive_link" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
